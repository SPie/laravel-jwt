...
return [
    ...
    Registrar::SETTING_SIGNER                   => env('JWT_SIGNER', Lcobucci\JWT\Signer\Hmac\Sha256::class),
    Registrar::SETTING_ACCESS_TOKEN_PROVIDER    => [
        Registrar::SETTING_CLASS => env('JWT_ACCESS_TOKEN_PROVIDER', SPie\LaravelJWT\TokenProvider\HeaderTokenProvider::class),
        Registrar::SETTING_KEY   => env('JWT_ACCESS_TOKEN_KEY', 'Authorization'),
        Registrar::SETTING_TTL   => env('JWT_ACCESS_TOKEN_TTL', 10)
    ],
    Registrar::SETTING_TOKEN_BLOCK_LIST => env('JWT_BLOCK_LIST', SPie\LaravelJWT\BlockList\CacheTokenBlockList::class),
